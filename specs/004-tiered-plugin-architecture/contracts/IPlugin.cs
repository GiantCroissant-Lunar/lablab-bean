// Contract: IPlugin
// Purpose: Defines the plugin lifecycle surface for hosts
// Location: LablabBean.Plugins.Contracts/IPlugin.cs
// Pattern: IPluginContext isolates ALC boundary; IRegistry enables cross-ALC service registration
