// Contract: IRegistry
// Purpose: Cross-ALC service registry with priority-based selection
// Location: LablabBean.Plugins.Contracts/IRegistry.cs
// Pattern: Runtime type matching across AssemblyLoadContexts; priority for multi-impl resolution
